...
const Header = () => {
  return (
    ...
    {{backgroundImage:"url('/header_img.png')"}} id='Header'>
      <NavBar/>
      <div className='container mx-atuo text-center py-4 px-6 md:px-20 lg:px-32 text-white'>
        <h2 className='text-5xl sm:text-6xl md:text-[74px] max-w-3xl font-semibold pt-20 inline-block'>
